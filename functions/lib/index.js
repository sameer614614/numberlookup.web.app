...
const lookupRoutes = ['/lookup', '/api/lookup'];
app.get(lookupRoutes, async (req, res) => {
...
const postsRoutes = ['/posts', '/api/posts'];
app.get(postsRoutes, async (_req, res) => {
    try {
...
const postRoutes = ['/posts/:slug', '/api/posts/:slug'];
app.get(postRoutes, async (req, res) => {
    try {
...
const healthRoutes = ['/healthz', '/api/healthz'];
app.get(healthRoutes, async (_req, res) => {
    let cacheStatus = 'ok';
    try {
